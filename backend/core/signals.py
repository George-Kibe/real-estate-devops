...
from .models import Billing  # Adjust import
...
def create_or_update_billing_for_report(sender, instance, created, **kwargs):
    if created:
        Billing.objects.create(
            ...
            worked_hours=instance.end_time.hour - instance.start_time.hour,
            billed_hours=instance.end_time.hour - instance.start_time.hour,
        ...
        try:
            ...
            billing.worked_hours=instance.end_time.hour - instance.start_time.hour,
            billing.billed_hours=instance.end_time.hour - instance.start_time.hour,
            billing.claim_amount= (instance.end_time.hour - instance.start_time.hour) * 20,
