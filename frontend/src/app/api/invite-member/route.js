  ...
  if (req.method === 'POST') {
    ...
    try {
      ...
      const mailOptions = {
        ...
        to: email,
        subject: `Invitation to ${username}'s AptTrack Organization`,
        html: `
          <!DOCTYPE html>
          <html lang="en">
          <head>
              ...
              <title>Invitation to AptTrack Organization</title>
          </head>
              ...
              <table style="width: 100%; max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
                  <tr style="background-color: #0044cc; color: #ffffff;">
                      <td style="padding: 20px; text-align: center;">
                          <h2 style="margin: 0;">Invitation to ${username}'s AptTrack Organization</h2>
                      </td>
                  </tr>
                  <tr>
