...
const FeaturesPage = () => {
  // add state and complete with stripe checkout
  // POST request 
        ...
        <div className="-mx-4 flex flex-wrap justify-center">
          <div className="-mx-4 flex flex-wrap">
            ...
            <PricingCard
              ...
              active
              pay_link={process.env.UNLIMITEDRENT_BUSINESS_LINK}
            >
              <List>5 User</List>
              <List>All UI components</List>
              <List>Lifetime access</List>
    ...
    <>
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="relative z-10 mb-10 overflow-hidden rounded-[10px] border-2 border-stroke  px-8 py-10 shadow-pricing dark:border-dark-3 dark:bg-dark-2 sm:p-12 lg:px-6 lg:py-10 xl:p-[50px]">
          ...
          <Link
            href={pay_link? pay_link : ""}
            className={` ${
              active
                ? "block w-full rounded-md border border-primary bg-primary p-3 text-center text-base font-medium text-lime-400 transition hover:bg-opacity-90"
