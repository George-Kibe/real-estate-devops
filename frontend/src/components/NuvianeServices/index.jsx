      ...
      <div className="text-[#0B2B5F]relative px-8 py-16 max-xl:px-4 max-xl:py-4 max-lg:px-8 max-md:px-6">
        ...
        <div className="mb-4 grid grid-cols-2 p-4 gap-x-16 max-xl:mb-12 max-md:mb-16 max-md:grid-cols-1 max-md:gap-y-10">
          <div className="flex flex-col z-1 flex-1 max-w-2xl justify-center max-md:row-start-1 max-md:max-w-max">
            ...
            <div className="gap-6 ">
                <p className="mt-2 flex"> <Dot />Who did you contact yesterday?</p>
                <p className="mt-2 flex "> <Dot />What was the status of that property?</p>
                <p className="mt-2 flex "> <Dot />Were waiting list applications signed?</p>
                <p className="mt-2 flex "> <Dot />Have you searched a specific apartment?</p>
            </div>
          </div>
          <figure className="max-w-2xl">
            <img
        ...
        <div className="mb-4 grid grid-cols-2 p-4 gap-x-16 max-xl:mb-12 max-md:mb-16 max-md:grid-cols-1 max-md:gap-y-10">
          ...
          <div className="flex flex-col z-1 flex-1 max-w-2xl justify-center max-md:row-start-1 max-md:max-w-max">
            ...
            <div className="gap-6 ">
                <p className="mt-2 flex"><Dot />Log all apartment searches, contracts and notes </p>
                <p className="mt-2 flex "><Dot />Store documents and applications in pdf </p>
                <p className="mt-2 flex "> <Dot />Set reminders for client follow ups</p>
            </div>
          </div>
