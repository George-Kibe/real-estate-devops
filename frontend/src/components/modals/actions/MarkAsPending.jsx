  ...
  return (
    ...
    > 
      ...
      >
        ...
        <p className="font-semibold text-xl mb-4 pr-2">Mark Property as Pending </p>
        <p className="">You are setting this property status to pending. This will notify the relevant parties that the property is under review and waiting for further action.</p>
        <div className="flex flex-col gap-2 mt-4 ">
            <p className="font-semibold pr-2">
              Please provide a reason for marking it as pending
            </p>
        ...
        <div className="flex flex-col justify-end md:flex-row gap-4">
          ...
          <Button onClick={markPropertyAsPending} className="mt-2 bg-green-600 hover:bg-lime-500 rounded-xs">
            Pending
          </Button>
        </div>
      </div>
...
export default MarkAsPendingModal;